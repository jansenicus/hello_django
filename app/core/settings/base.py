...
# SAMEORIGIN: Allows framing only from the same origin (less strict).
...
# defined in the environment-specific settings files (dev.py, prod.py)
...
STATICFILES_DIRS = [
    BASE_DIR / "static",
    BASE_DIR / "assets",  # optional extra folders
]
